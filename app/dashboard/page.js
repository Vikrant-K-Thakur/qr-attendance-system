...
const navItems = [
  { label: "Scan Attendance", icon: QrCode, href: "/", desc: "Scan QR codes to mark attendance" },
  { label: "Convert to JSON", icon: FileJson, href: "/dashboard/convert-data", desc: "Convert CSV/Excel file to JSON format" },
  { label: "Add Participant", icon: Users, href: "/dashboard/add-participant", desc: "Register new participants to database" },
  { label: "Send Tickets", icon: Ticket, href: "/dashboard/send-tickets", desc: "Send event tickets to participants via email" },
  { label: "Total Attendance", icon: BarChart2, href: "/dashboard/attendance", desc: "View attendance records and stats" },
  { label: "Send Certificates", icon: Award, href: "/dashboard/certificates", desc: "Send certificates to attendees via email" },
];
